            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="/pages/sosialisasi-sekolah" class="nav-link">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-6">
                            <!-- small box -->
                            <div class="small-box bg-white text-center px-2 py-2">
                                <div class="row">
                                    <div class="inner col-6">
                                        <p class="text-blacks">Jumlah Dosen</p>
                                        <h3 class="text-blacks">45</h3>
                                    </div>
                                    <div class="col-6">
                        ...
                        <div class="col-lg-6 col-6">
                            ...
                            <div class="small-box bg-white text-center px-2 py-2">
                                <div class="row">
                                    <div class="inner col-6">
                                        <p class="text-blacks">Total Honor Dosen</p>
                                        <h3 class="text-blacks">45 jt</h3>
                                    </div>
                                    <div class="col-6">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Realisasi Honor (Rp)</th>
                                                                <th>Progres Mengajar</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
...
<?php /**PATH C:\xampp\htdocs\siakad.piksiinputserang.ac.id\resources\views/admin/index.blade.php ENDPATH**/ ?>